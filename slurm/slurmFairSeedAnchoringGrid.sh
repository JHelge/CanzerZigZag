...
#SBATCH --job-name=BRCA_fair_seed_anchoring
...
# ============================================================
# Dataset selection
# Uncomment the dataset block you want to analyze.
# ============================================================
...
SCRIPT=/prj/ml-ident-canc/original_codes/scDiffusion/zigzag_refactored_safe_chat/analysis/fair_selected_seed_anchoring_grid.py
...
echo "============================================================"
echo "Fair seed anchoring grid analysis"
echo "============================================================"
...
if [ ! -f "$SCRIPT" ]; then
  echo "ERROR: fair_selected_seed_anchoring_grid.py not found: $SCRIPT"
  exit 1
fi
...
python -u "$SCRIPT" \
  ...
  --n_perm 1000 \
  --cloud_pairs 20000 \
  --max_cloud_expr_decode 2000 \
  --seed 17 \
  --out_csv "$OUT_DIR/fair_seed_anchoring_grid_summary.csv"

echo "============================================================"
echo "DONE"
echo "Wrote:"
echo "$OUT_DIR/fair_seed_anchoring_grid_summary.csv"
echo "============================================================"
