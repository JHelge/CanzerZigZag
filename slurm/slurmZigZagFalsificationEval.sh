...
#SBATCH --job-name=CRC_zigzag_falsification_eval
...
SCRIPT=/prj/ml-ident-canc/original_codes/scDiffusion/zigzag_refactored_safe_chat/analysis/zigzag_fair_falsification_eval.py
...
python -u "$SCRIPT" \
  ...
  --out_prefix zigzag_falsification \
  --seed 17
